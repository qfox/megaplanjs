...
var http = require('http')
  , https = require('https')
  , qs = require('qs')
  , errors = require('lib/megaplan/dicts.js').request_errors
 ...
 * @param {String} uri Base uri of megaplan API
 * @param {Object} [data] Some data to send to Megaplan API
 * @param {String|Function} [res_data_filter] Some key to return from response instead of all data or callback to filter response data
 * @param {Function} [req_data_filter] Callback to filter request data. keysToPascalCase by default
 */
...
Request.prototype = {
	 ...
	 * @class MegaplanRequest
	 * @method send
	 * @param {Function} [success] Callback for fine results
	 * @param {Function} [fail] Callback for errors
	 * @param {MegaplanRequest} fixit?
	 */
