...
var inherits = require('util').inherits
  ...
  , Request = require('lib/megaplan/request.js')
  , ServerConf = require('lib/megaplan/serverconf.js')
...
var clientProto = {
	...
	tasks: function (status, folder, favorites_only, search, detailed, only_actual, filter_id, count, employee_id, sort_by, sort_order, show_actions, limit, offset) {
		...
		(o instanceof Object) || (o = {
			...
			show_actions: show_actions ? true : false,
			limit: limit,
			offset: offset
		});

		return this.__request('::task/list.api', o, 'tasks');
	},
	...
	projects: function (o) {
		o = o || {};
		return this.__request('::project/list.api', o);
	},

	project_create: function (o) {
		o = o || {};
		return this.__request('::project/Create.api', o);
	},

	project_edit: function (o) {
		return this.__request('::project/edit.api', o);
	},

	project_action: function (o) {
		return this.__request('::project/action.api', o);
	},
	...
	todolists: function (o) {
		return this.__request('::todo/list.api', o);
	},
	...
	todolist_create: function (name) {
		...
		return this.__request('::todo/create.api', o);
	},

	todolist_edit: function (o) {
		return this.__request('::todo/edit.api', o);
	},

	todolist_delete: function (o) {
		return this.__request('::todo/delete.api', o);
	},

	events: function (o) {
		return this.__request('::event/list.api', o);
	},


	// == employers and departments ==
	employees: function (o) {
		return this.__request('::employee/list.api', o);
	},

	employee_card: function (o) {
		return this.__request('::employee/card.api', o);
	},

	employee_create: function (o) {
		return this.__request('::employee/create.api', o);
	},

	employee_edit: function (o) {
		return this.__request('::employee/edit.api', o);
	},

	departments: function (o) {
		return this.__request('::department/list.api', o);
	},
	...
	add_online_store: function (o) {
		return this.__request(':trade/Deal/createFromOnlineStore.api', o);
	},
	...
	contractors: function (filter_id, search, limit, offset) {
		...
		return this.__request('::contractor/list.api', o, 'clients');
	}
};
