...
var clientProto = {
	 ...
	 * @param {String} hours Time spent for a subject item (task usually). Время, потраченное на эту позицию (обычно задача).
	 ...
	 * 
	 * Параметры: Объект - хеш из access_id, secret_key и некоторая другая информация об авторизации при удачном входе или об ошибке
	 *
