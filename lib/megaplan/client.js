 ...
 * [More info]{@link https://help.megaplan.ru/API}
 * @constructor
...
var clientProto = {
	...
	/**
	 * @memberof MegaplanClient
	 * @event auth
	 * @description Params: Object - o hash with access_id, secrey_key, and some other auth information on success or error on fail 
	 */
	EVN_AUTH: 'auth',
	 ...
	 * More info [here (get history on one subject)]{@link https://help.megaplan.ru/API_system_datetime} and [here (get history on all subjects)]{@link https://help.megaplan.ru/API_history_all}
	 * 
	 * @memberof MegaplanClient
	 ...
	 * @param {Object} [attaches] There is no support of attaches at the moment. Sorry. Должен содержать ключ add в котором находится массив с файлами
    ...
    */
	 ...
	 *
	 * @memberof MegaplanClient
	 * @param {Object} o parameters of request. More info in official documentation
	 * @return {MegaplanRequest}
	 */
	projects: function (o) {
		o = o || {};
